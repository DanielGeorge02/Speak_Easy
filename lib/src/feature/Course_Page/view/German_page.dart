...
import '../widget/course_pageWidget.dart';

class German_Page extends StatefulWidget {
  const German_Page({super.key});

  @override
  State<German_Page> createState() => _German_PageState();
}
...
List content1 = [
  ...
  "MasterGreman Language Course A-Z™ :",
  "German Language Course for Beginners:",
  "MasterGreman Language Course A-Z™ :"
];
List content2 = [
...
class _German_PageState extends State<German_Page> {
  @override
